...
public class ColorUtil {
    ...
    public static String reverseColor(String colorHex){
        int colorInt = hex2Int(colorHex);

        int[] rgbArr = int2Rgb(colorInt);
        rgbArr[0] = 255 - rgbArr[0];
        rgbArr[1] = 255 - rgbArr[1];
        rgbArr[2] = 255 - rgbArr[2];


        return rgb2Hex(rgbArr);
